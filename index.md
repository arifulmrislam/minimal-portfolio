...
<div style="text-align: justify">We have been working on a proof of concept since last year. We offered to McDonald's how to minimize their energy and their other consumption cost like water, gas and so on. We installed the LoRaWAN network in their one restaurant. Initially, we used five Eastron energy meters to collect different energy field consumption and observe the average consumption of twenty-four hours. After that, we make a threshold, If the energy consumption is more than the set limit we will give them a notification by mail. With this solution they can save their total energy cost 15% to 20%. For this project, we use the famous IoT platform Thingsboard and LoRaWAN based sensors. Finally, They accept our concept, and We are working now with their other restaurants in Romania.</div>
